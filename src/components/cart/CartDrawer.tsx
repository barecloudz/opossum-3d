...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed inset-y-0 right-0 w-full max-w-md bg-brand-charcoal z-50 flex flex-col shadow-xl">
        {/* Header */}
              ...
              {items.map((item) => {
                ...
                return (
                  <li
                    ...
                    className="flex gap-4 bg-brand-black rounded-lg p-3"
                  >
                    {/* Product image placeholder */}
                    <div className="w-20 h-20 bg-brand-gray rounded-lg flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="p-1 bg-brand-gray rounded hover:bg-brand-gray-light transition-colors"
                          >
